...
namespace
{
	auto trim = [](std::string& s) {
		std::erase_if(s, [](unsigned char ch) { return std::isspace(ch); });
		};
}
...
//{
//	return from_sys_date_.months();
//}
//
//Duration Duration::operator-() const noexcept
//{
//	return Duration(-days_);
//}
//
