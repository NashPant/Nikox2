...
static void JpmcdsAddToRecord(const char *buffer);
...
***************************************************************************
*/
static int FileCreate(const char *fileName, TBoolean append);
...
***************************************************************************
*/
EXPORT int JpmcdsErrMsgFileName(const char *fileName, TBoolean append)
{
...
***************************************************************************
*/
EXPORT const char* JpmcdsErrMsgGetFileName(void)
{
    return GetFileName();
}
...
***************************************************************************
*/
void JpmcdsErrLogWrite(const char *message)
{
    if (!pWriteMessage)
        return;  /* Message writing not turned on */
...
(const char *routine /* (I) Name of routine published in error log. */
)
{
